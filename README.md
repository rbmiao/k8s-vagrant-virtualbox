...
Create a local kubernetes cluster using virtualbox on my MacBook pro.  A modification of the great work [danielepolencic](https://github.com/danielepolencic) did in his [gist](https://gist.github.com/danielepolencic/ef4ddb763fd9a18bf2f1eaaa2e337544).
...
```bash
$ git clone git@github.com:rbmiao/k8s-vagrant-virtualbox.git
